...
export default class Chart extends Component {
  ...
  return (
    <div id="wrapper">
        ...
        <g style={{transform: `translateY(${dimensions.boundedHeight}px)`}}><line
        className="Axis__line" scale={xScale} call={xAxisGenerator} 
        x2={dimensions.boundedWidth}
      /></g>
          <g ><line scale={yScale}  call={yAxisGenerator}
      ...
      /></g>
          ...
          <path d={ lineGenerator(dataset)} fill={"none"} stroke={"#010172"} strokeWidth={2}/>
        </svg>
   </div>
  );
  }
